# funk
Interpreter for a subset of the Haskell language. Note that this project is in an early experimental phase. The type inference code is based on https://github.com/sdiehl/write-you-a-haskell 
